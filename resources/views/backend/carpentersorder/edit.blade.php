            ...
            <h5 class="mb-0" ><strong>Items</strong></h5>
                ...
                <div class="mt-4 mb-4 p-3 bg-white border shadow-sm lh-sm">
                    ...
                    <div class="product-list">
                        <form action="{{ route('carpenterorder.update',$carpenterorders->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row border-bottom mb-4">
                                <div class="col-sm-8 pt-2"></div>
                                <div class="col-sm-4 text-right pb-3">
                                    <a class="btn btn-round btn-theme ms-auto" href="{{ route('carpenterorder.index')}}">
