<x-backend>
            <h5 class="mb-0" ><strong>Shipping</strong></h5>
                <span class="text-secondary">Shipping <i class="fa fa-angle-right"></i> Edit</span>
                ...
                <div class="mt-4 mb-4 p-3 bg-white border shadow-sm lh-sm">
                    ...
                    <div class="product-list">
                        ...
                        <div class="row border-bottom mb-4">
                            <div class="col-sm-8 pt-2"><h6 class="mb-4 bc-header">Shipping Editing</h6></div>
                        ...
                        <form action="{{ route('shipping.update', $shipping->id) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <label for="name_id" class="col-sm-2 coll-form-lable">Township</label>
                                    <div class="col-sm-10">
                                        <select class="form-control" name="townshipsid">
                                            <option value="0"> Choose Township </option>
                                            @foreach($townships as $township)
                                            <option value="{{($township->id)}}"
                                                @if($township->id==$shipping->township_id)selected
                                ...
                                <div class="form-group row">
                                    <label for="name_id" class="col-sm-2 col-form-label"> Fee </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control @error('fee')is-invalid @enderror"  id="name_id" name="fee" value="{{ $shipping->fee }}">
                                            @if($errors->first('fee'))
