<x-backend>
            <h5 class="mb-0" ><strong>Shipping</strong></h5>
                <span class="text-secondary">Shipping <i class="fa fa-angle-right"></i> List</span>
                ...
                <div class="mt-4 mb-4 p-3 bg-white border shadow-sm lh-sm">
                    ...
                    <div class="product-list">
                        ...
                        <div class="row border-bottom mb-4">
                            <div class="col-sm-8 pt-2"><h6 class="mb-4 bc-header">Shipping listing</h6></div>
                            <div class="col-sm-4 text-right pb-3">
                                <a class="btn btn-round btn-theme ms-auto" href="{{route('shipping.create')}}"><i class="fa fa-plus"></i> Add Shipping</a>
                        ...
                        <div class="table-responsive product-list">
                            ...
                            <table class="table table-bordered table-striped mt-3" id="productList">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> {{ $i++}} </td>
                                            <td> {{$shipping->township->name}} </td>
                                            <td>{{$fee}}</td>
                                        <td>
                                            <a href="{{route('shipping.edit',$shipping->id)}}" class="btn btn-link text-theme p-1"><i class="fa fa-pencil"></i>
                                            </a>
